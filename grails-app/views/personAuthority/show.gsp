...
<html>
    ...
    <body>
        ...
        <div id="show-personAuthority" class="content scaffold-show" role="main">
            ...
            <f:display bean="personAuthority" />
            <g:form resource="${this.personAuthority}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.personAuthority}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
